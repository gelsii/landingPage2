...
export const animation = () => {
    ...
    function gsapAnimation(properties) {
    ...
    function elevateYourOffice() {
        ...
        const idTextElements = ["text-elevate", "text2-elevate", "text3-elevate", "title1-elevate", "title2-elevate", "title3-elevate"];
        const idImgElements = ["img1-elevate", "img2-elevate", "img3-elevate"];
        for (let numberOfLoop = 0; numberOfLoop < idTextElements.length && idImgElements.length; numberOfLoop++) {
            gsapAnimation({
    ...
    function estion() {
        const idElements = ["title0-estion", "title1-estion", "title2-estion", "title3-estion", "title4-estion", "title5-estion", "title6-estion"];
        const delayAnimation = [.1, .2, .3, .4, .5, .6, .7];
        for (let numberOfLopp = 0; numberOfLopp < idElements.length; numberOfLopp++) {
            gsapAnimation({
    ...
    const callingAnimations = async () => {
        ...
        await heroSection();
        await diffBranch();
        await featuredBranch();
        await elevateYourOffice();
        await tables();
        await teamsLove();
        await branchExpert();
        await trustedTeams();
