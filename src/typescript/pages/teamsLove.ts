export const loopComment = (): void => {
  const paragraphText = (number: number): string => {
    let text = "";
    switch (number) {
      case 0:
        text =
  ...
  const UserTitleText = (number: number): string => {
    let text = "";
  ...
  const JobTitleText = (number: number): string => {
    let text = "";
  ...
  for (let numberOfLoop: number = 0; numberOfLoop < 6; numberOfLoop++) {
    
    const elements: {
      MainDiv: HTMLDivElement;
      ContainerStar: HTMLDivElement;
      ContainerText: HTMLDivElement;
      UserComment: HTMLParagraphElement;
      UserTitle: HTMLHeadingElement;
      JobTitle: HTMLHeadingElement;
    } = {
    ...
    const styleMainDiv = () => {
      ...
      elements.MainDiv.id = "title-teamsLove"
    };
